...
static if (_WIN32_WINNT >= 0x501) {
	...
	enum WTS_CONSOLE_CONNECT = 0x1;
	enum WTS_CONSOLE_DISCONNECT = 0x2;
	enum WTS_REMOTE_CONNECT = 0x3;
	enum WTS_REMOTE_DISCONNECT = 0x4;
	enum WTS_SESSION_LOGON = 0x5;
	enum WTS_SESSION_LOGOFF = 0x6;
	enum WTS_SESSION_LOCK = 0x7;
	enum WTS_SESSION_UNLOCK = 0x8;
	enum WTS_SESSION_REMOTE_CONTROL = 0x9;
...
enum DEVICE_NOTIFY_WINDOW_HANDLE = 0x00000000;
enum DEVICE_NOTIFY_SERVICE_HANDLE = 0x00000001;
...
static if (_WIN32_WINNT >= 0x501) {
	...
	enum CONSOLE_APPLICATION_16BIT = 0x00000001;
...
enum {
	...
	EVENT_SYSTEM_ALERT,
	EVENT_SYSTEM_FOREGOUND,
	EVENT_SYSTEM_MENUSART,
	EVENT_SYSTEM_MENUED,
	EVENT_SYSTEM_MENUPPUPSTART,
	EVENT_SYSTEM_MENUPPUPEND,
