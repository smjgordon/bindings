/* Converted to D from ./jack/transport.h by htod */
...
//C     #ifndef __jack_transport_h__
//C     #define __jack_transport_h__
 ...
 */
//C     int  jack_release_timebase (jack_client_t *client) JACK_OPTIONAL_WEAK_EXPORT;
extern (C):
 ...
 * @return 0 on success, otherwise a non-zero error code.
 */
//C     int  jack_set_sync_callback (jack_client_t *client,
//C     			     JackSyncCallback sync_callback,
 ...
 * @return 0 on success, otherwise a non-zero error code.
 */
//C     int  jack_set_sync_timeout (jack_client_t *client,
//C     			    jack_time_t timeout) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 */
//C     int  jack_set_timebase_callback (jack_client_t *client,
//C     				 int conditional,
//C     				 JackTimebaseCallback timebase_callback,
//C     				 void *arg) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 */
//C     int  jack_transport_locate (jack_client_t *client,
//C     			    jack_nframes_t frame) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 */
//C     jack_transport_state_t jack_transport_query (const jack_client_t *client,
//C     					     jack_position_t *pos) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 * @param client the JACK client structure
 */
//C     jack_nframes_t jack_get_current_transport_frame (const jack_client_t *client) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 */
//C     int  jack_transport_reposition (jack_client_t *client,
//C     				jack_position_t *pos) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 * @param client the JACK client structure.
 */
//C     void jack_transport_start (jack_client_t *client) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 * @param client the JACK client structure.
 */
//C     void jack_transport_stop (jack_client_t *client) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 */
//C     void jack_get_transport_info (jack_client_t *client,
//C     			      jack_transport_info_t *tinfo) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 */
//C     void jack_set_transport_info (jack_client_t *client,
//C     			      jack_transport_info_t *tinfo) JACK_OPTIONAL_WEAK_EXPORT;
