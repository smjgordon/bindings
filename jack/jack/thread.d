/* Converted to D from ./jack/thread.h by htod */
module jack.thread;
/*
...
//C     #ifndef __jack_thread_h__
//C     #define __jack_thread_h__
...
//C     int jack_client_real_time_priority (jack_client_t*) JACK_OPTIONAL_WEAK_EXPORT;
extern (C):
...
//C     int jack_client_max_real_time_priority (jack_client_t*) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 */
//C     int jack_acquire_real_time_scheduling (pthread_t thread, int priority) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 */
//C     int jack_client_create_thread (jack_client_t* client,
//C                                    pthread_t *thread,
//C                                    int priority,
//C                                    int realtime, 	/* boolean */
//C                                    void *(*start_routine)(void*),
//C                                    void *arg) JACK_OPTIONAL_WEAK_EXPORT;
int  jack_client_create_thread(jack_client_t *client, pthread_t *thread, int priority, int realtime, void * function(void *)start_routine, void *arg);
 ...
 */
//C     int jack_drop_real_time_scheduling (pthread_t thread) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 * @returns 0, if successful; otherwise an error number.
 */
//C     int jack_client_stop_thread(jack_client_t* client, pthread_t thread) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 * @returns 0, if successful; otherwise an error number.
 */
//C      int jack_client_kill_thread(jack_client_t* client, pthread_t thread) JACK_OPTIONAL_WEAK_EXPORT;
int  jack_client_kill_thread(jack_client_t *client, pthread_t thread);

//C     #ifndef WIN32

//C      typedef int (*jack_thread_creator_t)(pthread_t*,
//C     				     const pthread_attr_t*,
//C     				     void* (*function)(void*),
//C     				     void* arg);
/**
 ...
 *
 */
//C     void jack_set_thread_creator (jack_thread_creator_t creator) JACK_OPTIONAL_WEAK_EXPORT;
