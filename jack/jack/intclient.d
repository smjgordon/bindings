/* Converted to D from ./jack/intclient.h by htod */
...
//C     #ifndef __jack_intclient_h__
//C     #define __jack_intclient_h__
 ...
 */
//C     char *jack_get_internal_client_name (jack_client_t *client,
//C                                          jack_intclient_t intclient);
extern (C):
 ...
 */
//C     jack_intclient_t jack_internal_client_handle (jack_client_t *client,
//C             const char *client_name,
//C             jack_status_t *status);
jack_intclient_t  jack_internal_client_handle(jack_client_t *client, char *client_name, jack_status_t *status);
 ...
 */
//C     jack_intclient_t jack_internal_client_load (jack_client_t *client,
//C             const char *client_name,
//C             jack_options_t options,
//C             jack_status_t *status, ...);
jack_intclient_t  jack_internal_client_load(jack_client_t *client, char *client_name, jack_options_t options, jack_status_t *status,...);
/**
 ...
 */
//C     jack_status_t jack_internal_client_unload (jack_client_t *client,
//C             jack_intclient_t intclient);
