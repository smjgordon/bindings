/* Converted to D from ./jack/ringbuffer.h by htod */
...
//C     #ifndef _RINGBUFFER_H
//C     #define _RINGBUFFER_H
...
extern (C):
alias _N1 jack_ringbuffer_data_t;

//C     typedef struct {
//C         char	*buf;
//C         volatile size_t write_ptr;
//C         volatile size_t read_ptr;
//C         size_t	size;
//C         size_t	size_mask;
//C         int	mlocked;
//C     }
 ...
 * otherwise.
 */
//C     jack_ringbuffer_t *jack_ringbuffer_create(size_t sz);
 ...
 */
//C     void jack_ringbuffer_free(jack_ringbuffer_t *rb);
 ...
 *
 */
//C     void jack_ringbuffer_get_read_vector(const jack_ringbuffer_t *rb,
//C                                          jack_ringbuffer_data_t *vec);
 ...
 * @param vec a pointer to a 2 element array of jack_ringbuffer_data_t.
 */
//C     void jack_ringbuffer_get_write_vector(const jack_ringbuffer_t *rb,
//C                                           jack_ringbuffer_data_t *vec);
 ...
 */
//C     size_t jack_ringbuffer_read(jack_ringbuffer_t *rb, char *dest, size_t cnt);
 ...
 * @return the number of bytes read, which may range from 0 to cnt.
 */
//C     size_t jack_ringbuffer_peek(jack_ringbuffer_t *rb, char *dest, size_t cnt);
 ...
 */
//C     void jack_ringbuffer_read_advance(jack_ringbuffer_t *rb, size_t cnt);
 ...
 */
//C     size_t jack_ringbuffer_read_space(const jack_ringbuffer_t *rb);
 ...
 * @param rb a pointer to the ringbuffer structure.
 */
//C     int jack_ringbuffer_mlock(jack_ringbuffer_t *rb);
 ...
 * @param rb a pointer to the ringbuffer structure.
 */
//C     void jack_ringbuffer_reset(jack_ringbuffer_t *rb);
 ...
 */
//C     void jack_ringbuffer_reset_size (jack_ringbuffer_t * rb, size_t sz);
 ...
 */
//C     size_t jack_ringbuffer_write(jack_ringbuffer_t *rb, const char *src,
//C                                  size_t cnt);
 ...
 */
//C     void jack_ringbuffer_write_advance(jack_ringbuffer_t *rb, size_t cnt);
 ...
 */
//C     size_t jack_ringbuffer_write_space(const jack_ringbuffer_t *rb);
