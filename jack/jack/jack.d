/* Converted to D from ./jack/jack.h by htod */
module jack.jack;
/*
...
//C         int *minor_ptr,
//C         int *micro_ptr,
//C         int *proto_ptr) JACK_OPTIONAL_WEAK_EXPORT;
extern (C):
 ...
 */
//C     const char *
//C     jack_get_version_string() JACK_OPTIONAL_WEAK_EXPORT;
char * jack_get_version_string();
 ...
 */
//C     jack_client_t * jack_client_open (const char *client_name,
//C                                       jack_options_t options,
//C                                       jack_status_t *status, ...) JACK_OPTIONAL_WEAK_EXPORT;
...
*/
//C     jack_client_t * jack_client_new (const char *client_name) JACK_OPTIONAL_WEAK_DEPRECATED_EXPORT;
 ...
 */
//C     int jack_client_close (jack_client_t *client) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 */
//C     int jack_client_name_size (void) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 */
//C     char * jack_get_client_name (jack_client_t *client) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 */
//C     int jack_internal_client_new (const char *client_name,
//C                                   const char *load_name,
//C                                   const char *load_init) JACK_OPTIONAL_WEAK_DEPRECATED_EXPORT;
 ...
 * @deprecated Please use jack_internal_client_load().
 */
//C     void jack_internal_client_close (const char *client_name) JACK_OPTIONAL_WEAK_DEPRECATED_EXPORT;
 ...
 * @return 0 on success, otherwise a non-zero error code
 */
//C     int jack_activate (jack_client_t *client) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 * @return 0 on success, otherwise a non-zero error code
 */
//C     int jack_deactivate (jack_client_t *client) JACK_OPTIONAL_WEAK_EXPORT;
int  jack_deactivate(jack_client_t *client);

/**
 * @return pid of client. If not available, 0 will be returned.
 */
//C     int jack_get_client_pid (const char *name) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 * code.
 */
//C     pthread_t jack_client_thread_id (jack_client_t *) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 */
//C     int jack_is_realtime (jack_client_t *client) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 */
//C     jack_nframes_t jack_thread_wait (jack_client_t*, int status) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 */
//C         jack_nframes_t jack_cycle_wait (jack_client_t* client) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 */
//C     void jack_cycle_signal (jack_client_t* client, int status) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 * @return 0 on success, otherwise a non-zero error code.
*/
//C     int jack_set_process_thread(jack_client_t* client, JackThreadCallback thread_callback, void *arg) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 */
//C     int jack_set_thread_init_callback (jack_client_t *client,
//C                                        JackThreadInitCallback thread_init_callback,
//C                                        void *arg) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 */
//C     void jack_on_shutdown (jack_client_t *client,
//C                            JackShutdownCallback shutdown_callback, void *arg) JACK_WEAK_EXPORT;
 ...
 * jack_on_info_shutdown() will.
 */
//C     void jack_on_info_shutdown (jack_client_t *client,
//C                                 JackInfoShutdownCallback shutdown_callback, void *arg) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 * @return 0 on success, otherwise a non-zero error code.
 */
//C     int jack_set_process_callback (jack_client_t *client,
//C                                    JackProcessCallback process_callback,
//C                                    void *arg) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 * @return 0 on success, otherwise a non-zero error code.
 */
//C     int jack_set_freewheel_callback (jack_client_t *client,
//C                                      JackFreewheelCallback freewheel_callback,
//C                                      void *arg) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 * @return 0 on success, otherwise a non-zero error code
 */
//C     int jack_set_buffer_size_callback (jack_client_t *client,
//C                                        JackBufferSizeCallback bufsize_callback,
//C                                        void *arg) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 * @return 0 on success, otherwise a non-zero error code
 */
//C     int jack_set_sample_rate_callback (jack_client_t *client,
//C                                        JackSampleRateCallback srate_callback,
//C                                        void *arg) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 * @return 0 on success, otherwise a non-zero error code
 */
//C     int jack_set_client_registration_callback (jack_client_t *,
//C                            JackClientRegistrationCallback
//C                                                registration_callback, void *arg) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 * @return 0 on success, otherwise a non-zero error code
 */
//C      int jack_set_port_registration_callback (jack_client_t *,
//C                                               JackPortRegistrationCallback
//C                                               registration_callback, void *arg) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 * @return 0 on success, otherwise a non-zero error code
 */
//C     int jack_set_port_connect_callback (jack_client_t *,
//C                                         JackPortConnectCallback
//C                                         connect_callback, void *arg) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 * @return 0 on success, otherwise a non-zero error code
 */
//C     int jack_set_port_rename_callback (jack_client_t *,
//C                                        JackPortRenameCallback
//C                                        rename_callback, void *arg) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 * @return 0 on success, otherwise a non-zero error code
 */
//C     int jack_set_graph_order_callback (jack_client_t *,
//C                                        JackGraphOrderCallback graph_callback,
//C                                        void *) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 * @return 0 on success, otherwise a non-zero error code
 */
//C     int jack_set_xrun_callback (jack_client_t *,
//C                                 JackXRunCallback xrun_callback, void *arg) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 * @return 0 on success, otherwise a non-zero error code.
 */
//C     int jack_set_freewheel(jack_client_t* client, int onoff) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 * @return 0 on success, otherwise a non-zero error code
 */
//C     int jack_set_buffer_size (jack_client_t *client, jack_nframes_t nframes) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 * jackd was started.
 */
//C     jack_nframes_t jack_get_sample_rate (jack_client_t *) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 * @see jack_set_buffer_size_callback()
 */
//C     jack_nframes_t jack_get_buffer_size (jack_client_t *) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 */
//C     int jack_engine_takeover_timebase (jack_client_t *) JACK_OPTIONAL_WEAK_DEPRECATED_EXPORT;
 ...
 */
//C     float jack_cpu_load (jack_client_t *client) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 */
//C     jack_port_t * jack_port_register (jack_client_t *client,
//C                                       const char *port_name,
//C                                       const char *port_type,
//C                                       unsigned long flags,
//C                                       unsigned long buffer_size) JACK_OPTIONAL_WEAK_EXPORT;
jack_port_t * jack_port_register(jack_client_t *client, char *port_name, char *port_type, uint flags, uint buffer_size);
 ...
 * @return 0 on success, otherwise a non-zero error code
 */
//C     int jack_port_unregister (jack_client_t *, jack_port_t *) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 */
//C     void * jack_port_get_buffer (jack_port_t *, jack_nframes_t) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 */
//C     const char * jack_port_name (const jack_port_t *port) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 * @see jack_port_name_size().
 */
//C     const char * jack_port_short_name (const jack_port_t *port) JACK_OPTIONAL_WEAK_EXPORT;
char * jack_port_short_name(jack_port_t *port);

/**
 * @return the @ref JackPortFlags of the jack_port_t.
 */
//C     int jack_port_flags (const jack_port_t *port) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 */
//C     const char * jack_port_type (const jack_port_t *port) JACK_OPTIONAL_WEAK_EXPORT;
char * jack_port_type(jack_port_t *port);

 /**
 * @return the @a port type id.
 */
//C     jack_port_type_id_t jack_port_type_id (const jack_port_t *port) JACK_OPTIONAL_WEAK_EXPORT;
jack_port_type_id_t  jack_port_type_id(jack_port_t *port);

/**
 * @return TRUE if the jack_port_t belongs to the jack_client_t.
 */
//C     int jack_port_is_mine (const jack_client_t *, const jack_port_t *port) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 */
//C     int jack_port_connected (const jack_port_t *port) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 * @see jack_port_name_size()
 */
//C     int jack_port_connected_to (const jack_port_t *port,
//C                                 const char *port_name) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 */
//C     const char ** jack_port_get_connections (const jack_port_t *port) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 * @see jack_port_name_size()
 */
//C     const char ** jack_port_get_all_connections (const jack_client_t *client,
//C                                                  const jack_port_t *port) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 * JACK clients.
 */
//C     int jack_port_tie (jack_port_t *src, jack_port_t *dst) JACK_OPTIONAL_WEAK_DEPRECATED_EXPORT;
 ...
 * JACK clients.
 */
//C     int jack_port_untie (jack_port_t *port) JACK_OPTIONAL_WEAK_DEPRECATED_EXPORT;
 ...
 * port.
 */
//C     jack_nframes_t jack_port_get_latency (jack_port_t *port) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 */
//C     jack_nframes_t jack_port_get_total_latency (jack_client_t *,
//C                                                 jack_port_t *port) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 */
//C     void jack_port_set_latency (jack_port_t *, jack_nframes_t) JACK_OPTIONAL_WEAK_EXPORT;
...
*         otherwise.
*/
//C     int jack_recompute_total_latency (jack_client_t*, jack_port_t* port) JACK_OPTIONAL_WEAK_EXPORT;
...
*         otherwise.
*/
//C         int jack_recompute_total_latencies (jack_client_t*) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 * @return 0 on success, otherwise a non-zero error code.
 */
//C     int jack_port_set_name (jack_port_t *port, const char *port_name) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 * @return 0 on success, otherwise a non-zero error code.
 */
//C     int jack_port_set_alias (jack_port_t *port, const char *alias) JACK_OPTIONAL_WEAK_EXPORT;
int  jack_port_set_alias(jack_port_t *port, char *jalias);
 ...
 * @return 0 on success, otherwise a non-zero error code.
 */
//C     int jack_port_unset_alias (jack_port_t *port, const char *alias) JACK_OPTIONAL_WEAK_EXPORT;
int  jack_port_unset_alias(jack_port_t *port, char *jalias);
 ...
 */
//C     int jack_port_get_aliases (const jack_port_t *port, char* const aliases[2]) JACK_OPTIONAL_WEAK_EXPORT;
int  jack_port_get_aliases(jack_port_t *port, char **jaliases);

/**
 * If @ref JackPortCanMonitor is set for this @a port, turn input
 * monitoring on or off.  Otherwise, do nothing.
 */
//C     int jack_port_request_monitor (jack_port_t *port, int onoff) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 * @see jack_port_name_size()
 */
//C     int jack_port_request_monitor_by_name (jack_client_t *client,
//C                                            const char *port_name, int onoff) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 * @return 0 on success, otherwise a non-zero error code
 */
//C     int jack_port_ensure_monitor (jack_port_t *port, int onoff) JACK_OPTIONAL_WEAK_EXPORT;
int  jack_port_ensure_monitor(jack_port_t *port, int onoff);

/**
 * @return TRUE if input monitoring has been requested for @a port.
 */
//C     int jack_port_monitoring_input (jack_port_t *port) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 */
//C     int jack_connect (jack_client_t *,
//C                       const char *source_port,
//C                       const char *destination_port) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 * @return 0 on success, otherwise a non-zero error code
 */
//C     int jack_disconnect (jack_client_t *,
//C                          const char *source_port,
//C                          const char *destination_port) JACK_OPTIONAL_WEAK_EXPORT;
int  jack_disconnect(jack_client_t *, char *source_port, char *destination_port);
 ...
 * jack_disconnect().
 */
//C     int jack_port_disconnect (jack_client_t *, jack_port_t *) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 * character.
 */
//C     int jack_port_name_size(void) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 * including the final NULL character.  This value is a constant.
 */
//C     int jack_port_type_size(void) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 */
//C     const char ** jack_get_ports (jack_client_t *,
//C                                   const char *port_name_pattern,
//C                                   const char *type_name_pattern,
//C                                   unsigned long flags) JACK_OPTIONAL_WEAK_EXPORT;
char ** jack_get_ports(jack_client_t *, char *port_name_pattern, char *type_name_pattern, uint flags);
 ...
 * @see jack_port_name_size()
 */
//C     jack_port_t * jack_port_by_name (jack_client_t *, const char *port_name) JACK_OPTIONAL_WEAK_EXPORT;
jack_port_t * jack_port_by_name(jack_client_t *, char *port_name);

/**
 * @return address of the jack_port_t of a @a port_id.
 */
//C     jack_port_t * jack_port_by_id (jack_client_t *client,
//C                                    jack_port_id_t port_id) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 */
//C     jack_nframes_t jack_frames_since_cycle_start (const jack_client_t *) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 */
//C     jack_nframes_t jack_frame_time (const jack_client_t *) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 */
//C     jack_nframes_t jack_last_frame_time (const jack_client_t *client) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 */
//C     jack_time_t jack_frames_to_time(const jack_client_t *client, jack_nframes_t) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 */
//C     jack_nframes_t jack_time_to_frames(const jack_client_t *client, jack_time_t) JACK_OPTIONAL_WEAK_EXPORT;
 ...
 */
//C     jack_time_t jack_get_time() JACK_OPTIONAL_WEAK_EXPORT;
 ...
 */
//C     extern void (*jack_error_callback)(const char *msg) JACK_OPTIONAL_WEAK_EXPORT;
extern void  function(char *msg)jack_error_callback;
 ...
 */
//C     void jack_set_error_function (void (*func)(const char *)) JACK_OPTIONAL_WEAK_EXPORT;
void  jack_set_error_function(void  function(char *)func);
 ...
 */
//C     extern void (*jack_info_callback)(const char *msg) JACK_OPTIONAL_WEAK_EXPORT;
extern void  function(char *msg)jack_info_callback;
 ...
 */
//C     void jack_set_info_function (void (*func)(const char *)) JACK_OPTIONAL_WEAK_EXPORT;
void  jack_set_info_function(void  function(char *)func);
 ...
 *
 */
//C     void jack_free(void* ptr) JACK_OPTIONAL_WEAK_EXPORT;
